...
Color colorOne = Color(0xFF541013);
Color colorTwo = Color(0xFF751519);
Color colorThree = Color(0xFF9b1b20);
...
class TopWaveClipper1 extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    //creating first curver near bottom left corner
    var firstControlPoint = new Offset(size.width / 10, size.height - 30);
