...
class EssentialNews extends StatefulWidget with NavigationStates{
  @override
  _EssentialNewsState createState() => _EssentialNewsState();
}

class _EssentialNewsState extends State<EssentialNews> {
  @override
